...
public interface ProductRepository extends JpaRepository<Product, Long>{
	...
	@Query("SELECT p FROM Product p WHERE p.category.name =:category OR p.category.parentCategory.name =:category OR p.category.parentCategory.parentCategory.name =:category")
